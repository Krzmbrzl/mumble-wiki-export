...
The first of those two new rules, expressed as "\~sub 0,1" denies
...
If a player joins a channel they do not have Speak privilege in, they
...
You can test that it works alone by using the Text message permission
