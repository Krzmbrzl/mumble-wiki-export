...
## A Windows machine 
Since Murmur can't run without an active desktop on windows, you can safely ignore this setup. Just make sure your [murmur.ini](murmur.ini#dbus.md) says
<pre>
dbus=session
</pre>
...
In your [murmur.ini](murmur.ini#dbus.md), make sure it says
<pre>
dbus=system
</pre>
...
Make sure your [murmur.ini](murmur.ini#dbus.md) has 
<pre>
dbus=session
</pre>
...
If your host runs  [Docker](https://www.docker.com/), you can use  [Dockerfile](https://hub.docker.com/r/rabidfx/murmur-dbus/ RabidFX's) to create a SSL-capable, fully-autonomous Murmur server in minutes, with DBus capabilities (through the host's system bus).
...
* Direct the client to a [Mumble URL](Mumble URL.md)
* Get the current [Mumble URL](Mumble URL.md)
