'''NOTE: Please go to  [website](https://www.mumble.info/documentation/developer/positional-audio/create-plugin/ the new documentation on our) instead. The documentation here is now obsolete.'''
